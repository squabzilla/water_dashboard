...
output_txt = Path(PROJECT_ROOT) / "data_pipeline" / "EDA" / "test_data" / "weather_stations_output.txt"
...
output_json = Path(PROJECT_ROOT) / "data_pipeline" / "EDA" / "test_data" / "weather_stations.json"
...
output_file = Path(PROJECT_ROOT) / "data_pipeline" / "EDA" / "test_data" / "weather_stationgs_geojson.geojson"
