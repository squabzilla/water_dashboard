...
def _fetch_daily_MSC_GeoMet_daily_weather_last_14_days() -> gpd.GeoDataFrame:
    # get proper datetime string to use! first, subtract 2 weeks from current date
    day_minus_14 = date.today() - timedelta(days=14)
    ...
    gdf = fetch_weather_pages(start_url=daily_weather_url, params=daily_weather_params, job_title=f"last-14-daily-weather-records")
